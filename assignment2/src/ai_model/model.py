...
class RDUNet(nn.Module):
    ...
    """
    def __init__(self, channels=3, base_filters=128):
        super().__init__()
        ...
        # Encoder:
        # Level 0:
        self.input_block = InputBlock(self.channels, filters_0)
        ...
        self.output_block = OutputBlock(filters_0, self.channels)
...
# Initialize the model and set to the device
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
model = RDUNet(channels=3, base_filters=128).to(device)